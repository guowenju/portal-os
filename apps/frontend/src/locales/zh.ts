const zh = {
  ...
  app: {
    ...
    admin: {
      ...
      categories: '分类',
      tags: '标签',
      taxonomyName: '分类或标签名称',
      create: '创建',
      confirmTaxonomyDelete: '确定删除这个分类或标签吗？',
      noCategory: '不设置分类',
      noCover: '不设置封面',
      uploadImage: '上传图片',
      insertImage: '插入正文',
      copyUrl: '复制地址',
      confirmImageDelete: '确定删除这张图片吗？',
      chooseArticleFirst: '请先选择一篇文章',
      siteName: '站点名称',
      siteDescription: '站点简介',
      authorName: '作者名称',
      siteUrl: '站点完整 URL，例如 https://blog.example.com',
      noShareImage: '不设置默认分享图',
      saveSettings: '保存站点设置',
      restoreLocal: '发现本地未提交内容，是否恢复？',
      versionConflict: '文章已在其他窗口更新，请选择保留版本。',
      useServer: '使用服务端版本',
      keepLocal: '保留本地内容',
      saveState: {
        clean: '未修改',
